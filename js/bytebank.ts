...
const elementoFormulario = document.querySelector(".block-nova-transacao form") as HTMLFormElement //novamente o ts avisa
...
// pois o TS não consegue identificar o tipo da const inputTipo, então precisamor definir qual o tipo de cada const
    ...
    const inputTipo= elementoFormulario.querySelector("#tipoTransacao") as HTMLSelectElement//aqui inserimos o tipo da constante para que o value apareca sem erro
    const inputValor= elementoFormulario.querySelector("#valor") as HTMLInputElement ///aqui inserimos o tipo da constante para que o value apareca sem erro
    const inputData= elementoFormulario.querySelector("#data") as HTMLInputElement ///aqui inserimos o tipo da constante para que o value apareca sem erro
...
//como strings, e não é possivel fazer operaçoes aritmeticas com strings, portanto devemos definir os tipos de cada variavel
    ...
    let tipoTransacao: string= inputTipo.value 
